...
const CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      "Quần áo, Giày Sneaker",
      "Túi xách (Coach, MK, LV...)",
      "Kính mát, Đồng hồ",
    ],
...
const WEBSITES = [
  ...
  {
    name: "Jomashop",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/45/Jomashop_Logo.jpg/800px-Jomashop_Logo.jpg",
    url: "https://www.jomashop.com",
  }, // Fallback text if img fails
  {
    name: "Sephora",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Sephora_logo.svg/1200px-Sephora_logo.svg.png",
...
export const BuyingService: React.FC = () => {
  return (
    <>
      ...
      <div className="bg-slate-900 pt-32 pb-24 text-center text-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 animate-fade-in-up">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed mb-8">
            Bạn chỉ cần gửi link, EZWAY sẽ lo toàn bộ thủ tục thanh toán, thuế
            Mỹ, vận chuyển và thông quan. Tỷ giá tốt nhất thị trường.
          </p>
          <div className="flex justify-center gap-4">
            <Button to="/lien-he" size="xl" icon>
              Gửi Link Báo Giá Ngay
            </Button>
            <Button
              variant="outline"
              size="xl"
              className="border-slate-600 text-slate-300 hover:bg-white hover:text-slate-900 hover:border-white"
            >
              Xem Quy Trình
            </Button>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-8 lg:p-12 bg-slate-50">
                ...
                <div className="mt-8 p-4 bg-blue-50/50 rounded-xl border border-blue-100 text-sm text-slate-600">
                  ...
                  Tỷ giá tính theo Vietcombank bán ra + chênh lệch chuyển đổi
                  ngoại tệ (thấp hơn thị trường chợ đen).
                </div>
              </div>
              ...
              <div className="p-8 lg:p-12 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="space-y-5 text-sm md:text-base relative z-10">
                  ...
                  <div className="flex justify-between items-center pt-2">
                    ...
                    <div className="text-right">
                      <span className="block text-2xl font-bold text-green-400 font-mono">
                        $144.10
                      </span>
                ...
                <div className="mt-8 pt-6 border-t border-white/10 text-center">
                  <p className="text-sm text-slate-400 mb-4">
                    So với giá cửa hàng tại Việt Nam (~5.000.000đ)
                  </p>
      ...
      <Section bg="light">
        <SectionHeader
          title="Chúng tôi mua hộ những gì?"
          subtitle="Đa dạng ngành hàng"
        />
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {CATEGORIES.map((cat, idx) => (
            <Card
              key={idx}
              className="bg-white hover:border-primary transition-all duration-300"
            >
              <div className="mb-6">
      ...
      <Section>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div>
            <SectionHeader
              title="Tại sao nên chọn mua hộ?"
              subtitle="Giải pháp thông minh"
              align="left"
            />
            <p className="text-lg text-slate-600 mb-8 leading-relaxed">
              Việc tự mua hàng từ website Mỹ thường gặp rào cản về thẻ thanh
              toán (thẻ VN hay bị hủy đơn), địa chỉ nhận hàng tại Mỹ và thủ tục
              hải quan phức tạp khi về Việt Nam.
            </p>
              ...
              <div className="divide-y divide-slate-100">
                <div className="grid grid-cols-2 text-sm p-4 items-center">
                  <div className="flex items-center gap-2 text-slate-600">
                    <X className="w-4 h-4 text-red-500" /> Cần thẻ Visa/Master
                    Mỹ
                  </div>
                  <div className="flex items-center gap-2 text-slate-900 font-medium bg-blue-50/50 p-2 rounded">
                    <Check className="w-4 h-4 text-green-500" /> Chuyển khoản
                    VNĐ
                  </div>
                </div>
                <div className="grid grid-cols-2 text-sm p-4 items-center">
                  <div className="flex items-center gap-2 text-slate-600">
                    <X className="w-4 h-4 text-red-500" /> Rủi ro mất hàng cao
                  </div>
                  <div className="flex items-center gap-2 text-slate-900 font-medium bg-blue-50/50 p-2 rounded">
                    <Check className="w-4 h-4 text-green-500" /> Bảo hiểm 100%
                  </div>
                </div>
                <div className="grid grid-cols-2 text-sm p-4 items-center">
                  <div className="flex items-center gap-2 text-slate-600">
                    <X className="w-4 h-4 text-red-500" /> Tự lo thủ tục Hải
                    Quan
                  </div>
                  <div className="flex items-center gap-2 text-slate-900 font-medium bg-blue-50/50 p-2 rounded">
                    <Check className="w-4 h-4 text-green-500" /> Bao thuế &
                    Thông quan
                  </div>
                </div>
                <div className="grid grid-cols-2 text-sm p-4 items-center">
                  <div className="flex items-center gap-2 text-slate-600">
                    <X className="w-4 h-4 text-red-500" /> Web chặn IP Việt Nam
                  </div>
                  <div className="flex items-center gap-2 text-slate-900 font-medium bg-blue-50/50 p-2 rounded">
                    <Check className="w-4 h-4 text-green-500" /> Checkout mọi
                    website
                  </div>
                </div>
              </div>
      ...
      <div className="bg-slate-50 py-16 border-t border-slate-200">
        <div className="max-w-[1200px] mx-auto px-6">
          <p className="text-center text-slate-500 font-semibold mb-8 uppercase tracking-widest text-xs">
            Hỗ trợ mua hàng trên 100+ Website Mỹ
          </p>
          ...
          <div className="text-center mt-12">
            <Button
              ...
              variant="primary"
              icon
              className="shadow-teal-500/25"
            >
              Gửi Link Để Nhận Báo Giá
            </Button>
          </div>
        </div>
      </div>
