...
export const NEWS_POSTS = [
  {
    ...
    excerpt:
      "EZWAY thông báo điều chỉnh giảm cước phí vận chuyển đường bay cho các mặt hàng điện tử và thực phẩm chức năng. Xem chi tiết bảng giá mới nhất tại đây.",
    category: "Thông báo",
    date: "10/10/2024",
    author: "Admin EZWAY",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Black Friday là dịp sale lớn nhất năm. Hãy cùng EZWAY điểm qua các tips săn hàng hiệu giá rẻ và cách tránh tình trạng hủy đơn khi mua hàng tại Mỹ.",
    category: "Cẩm nang",
    date: "05/10/2024",
    author: "Minh Hạnh",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Để đảm bảo hàng hóa về trước Tết, quý khách vui lòng lưu ý các mốc thời gian chốt đơn (Cut-off time) cho đường bay và đường biển.",
    category: "Thông báo",
    date: "01/10/2024",
    author: "Admin EZWAY",
    image:
      "https://images.unsplash.com/photo-1548685913-fe6678babe8d?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
    featured: false,
  },
  {
    id: 4,
    ...
    excerpt:
      "Tổng cục Hải quan vừa ban hành quy định mới về việc nhập khẩu các thiết bị công nghệ đã qua sử dụng. Khách hàng cá nhân cần chuẩn bị những gì?",
    category: "Pháp lý",
    date: "28/09/2024",
    author: "Tuấn Luật",
    image:
      "https://images.unsplash.com/photo-1531297461136-82lw9b220371?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80",
    featured: false,
  },
  {
    id: 5,
    ...
    excerpt:
      "Đừng bỏ lỡ Sephora, FragranceNet hay Jomashop nếu bạn là tín đồ của hương thơm. Hướng dẫn cách check batch code và order về Việt Nam.",
    category: "Cẩm nang",
    date: "20/09/2024",
    author: "Lan Hương",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Tin vui cho các tín đồ công nghệ: Mua iPhone, MacBook gửi về kho Oregon sẽ tiết kiệm được 8-9% thuế bang (Sales Tax).",
    ...
    <>
      ...
      <div className="bg-gradient-to-br from-blue-50 via-white to-orange-50 pt-32 pb-20 text-center relative overflow-hidden">
        ...
        <div className="relative z-10 px-6">
          ...
          <p className="text-slate-600 text-lg max-w-2xl mx-auto animate-fade-in-up delay-200">
            Cập nhật thông tin mới nhất về thị trường Logistics, khuyến mãi và
            cẩm nang mua sắm quốc tế.
          </p>
        </div>
      </div>
      ...
      <Section className="pt-0">
        ...
        <div className="mt-20 pt-10 border-t border-slate-200">
          <h4 className="text-lg font-bold text-slate-900 mb-6 text-center">
            Chủ đề phổ biến
          </h4>
          <div className="flex flex-wrap justify-center gap-3">
            {[
              ...
              <span
                key={i}
                className="px-4 py-2 bg-slate-100 rounded-full text-slate-600 text-sm font-medium hover:bg-primary hover:text-white transition-colors cursor-pointer"
              >
                #{tag}
              </span>
            ))}
      ...
      <div className="bg-primary py-16">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-xl mx-auto">
            Nhận thông báo về các chương trình khuyến mãi, mã giảm giá vận
            chuyển và tin tức thị trường mới nhất.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-md mx-auto">
            <input
              type="email"
              placeholder="Email của bạn"
              className="px-6 py-3 rounded-xl bg-white text-slate-900 placeholder:text-slate-400 focus:outline-none w-full"
            />
            <Button variant="white" className="font-bold whitespace-nowrap">
              Đăng ký ngay
            </Button>
          </div>
        </div>
