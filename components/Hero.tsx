      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 lg:space-y-8 text-center lg:text-left">
            ...
            <p className="text-base lg:text-lg text-body max-w-xl leading-[1.7] mx-auto lg:mx-0 mb-10">
              ...
              {/* Primary Call to Action uses Orange (Accent) */}
                <Button to="/gia-cuoc" variant="cta" size="xl" icon className="shadow-orange-500/12">
                Nhận báo giá ngay
              </Button>
              ...
              <div className="pt-8 border-t border-border flex flex-wrap justify-center lg:justify-start gap-8 md:gap-10 text-body text-sm font-semibold py-6">
              ...
              <div className="flex items-center space-x-2">
               ...
               <div className="flex items-center space-x-2">
                  <div className="p-1.5 bg-orange-muted/10 rounded-full text-orange-muted"><Zap className="w-4 h-4" /></div>
          ...
          {/* Visual Right (5 cols) - Functional Tracking Widget */}
           <div className="lg:col-span-5 relative perspective-1000 mt-8 lg:mt-0">
            {/* Main Widget Card */}
            <div className="relative z-10 bg-white rounded-3xl p-8 border border-border shadow-card transform hover:translate-y-0 transition-transform duration-300">
                 {/* Widget Header */}
                ...
                <div className="relative mb-8 group">
                    <input 
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl py-4 pl-4 pr-14 text-slate-900 font-medium focus:outline-none focus:border-brand-blue focus:ring-4 focus:ring-brand-blue/8 transition-all placeholder:text-slate-400 shadow-inner"
                      value={trackingId}
                    ...
                    />
                      ...
                      onClick={handleSearch}
                       className="absolute right-2 top-2 bottom-2 bg-brand-blue hover:bg-brand-blue/90 text-white px-3 rounded-lg transition-colors shadow-md shadow-blue-500/8"
                    >
                    ...
                    <div className="space-y-6">
                      <div className="flex items-start gap-4 py-4 px-4 rounded-2xl bg-gradient-to-r from-blue-50 to-white border border-blue-100 shadow-sm">
                        <div className="mt-1 relative">
                           {/* Status Indicator Green for Success/Active */}
                          <div className="w-3 h-3 bg-accent rounded-full shadow-[0_0_0_6px_rgba(13,148,136,0.12)]"></div>
                        ...
                        <div>
                          ...
                          <p className="text-brand-navy text-sm font-bold leading-relaxed">Đã nhập kho Tân Sơn Nhất (SGN)</p>
                          <p className="text-xs text-muted mt-1">10:45 AM • Hôm nay</p>
                        </div>
                    </div>
                      <div className="flex items-start gap-4 py-4 pl-4 opacity-80 hover:opacity-100 transition-all">
                        <div className="mt-1">
                          <div className="w-3 h-3 bg-slate-300 rounded-full"></div>
                        </div>
                        <div>
                          <p className="text-slate-700 text-sm font-medium leading-relaxed">Đang vận chuyển (In Transit)</p>
            ...
            <div className="absolute -top-12 -right-12 w-24 h-24 bg-accent rounded-3xl rotate-12 opacity-12 blur-xl animate-float"></div>
            <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-brand-blue rounded-full opacity-6 blur-2xl animate-float animation-delay-2000"></div>
          </div>
        </div>
      </div>
    </div>
