          ...
          <div className="lg:col-span-8">
            <div className="bg-white rounded-2xl shadow-card p-8 md:p-12">
              ...
              <div className="prose prose-lg prose-slate max-w-none">
                ...
                <p>
                  Trong bối cảnh thị trường logistics toàn cầu đang có nhiều
                  biến động, việc cập nhật thông tin kịp thời là vô cùng quan
                  trọng đối với các doanh nghiệp và cá nhân thường xuyên giao
                  thương quốc tế.
                </p>

                <h3>1. Tại sao giá cước thay đổi?</h3>
                <p>
                  Theo thông tin mới nhất từ các hãng hàng không và tàu biển,
                  chi phí nhiên liệu đã tăng nhẹ trong quý này. Tuy nhiên, nhờ
                  việc tối ưu hóa quy trình vận hành tại kho Oregon và
                  California, EZWAY đã nỗ lực giữ bình ổn giá, thậm chí giảm nhẹ
                ...
                <p>
                  Để đảm bảo hàng hóa được thông quan nhanh chóng, quý khách vui
                  lòng cung cấp đầy đủ Invoice (Hóa đơn mua hàng) và Tracking
                  Number ngay sau khi order. Việc này giúp đội ngũ EZWAY khai
                  báo hải quan trước khi hàng về đến Việt Nam.
                </p>
                <ul className="list-disc pl-5 space-y-2">
                  <li>Hàng điện tử cần khai báo số Serial/IMEI.</li>
                  <li>
                    Hàng thực phẩm chức năng giới hạn số lượng theo quy định 6
                    lọ/người nhận.
                  </li>
                  <li>
                    Nước hoa và chất lỏng cần đóng gói gia cố đặc biệt (có phụ
                    phí).
                  </li>
                </ul>
                ...
                <p>
                  Chúng tôi cam kết bồi thường 100% giá trị hàng hóa nếu xảy ra
                  mất mát, hư hỏng trong quá trình vận chuyển (đối với đơn hàng
                  có mua bảo hiểm hoặc khai báo giá trị đầy đủ). Thời gian giao
                  hàng dự kiến từ 7-10 ngày làm việc kể từ khi bay.
                </p>
                ...
                <div className="bg-blue-50 border border-blue-100 p-6 rounded-xl my-8">
                  ...
                  <p className="text-slate-600 mb-4 text-sm">
                    Liên hệ ngay với đội ngũ CSKH của chúng tôi để được hỗ trợ
                    24/7.
                  </p>
                  <Button to="/lien-he" size="sm">
                    Chat với nhân viên
                  </Button>
                </div>
              </div>
              ...
              <div className="border-t border-slate-100 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="flex gap-2">
                  <span className="px-3 py-1 bg-slate-100 rounded text-xs font-bold text-slate-500 hover:bg-slate-200 cursor-pointer">
                    #Logistics
                  </span>
                  <span className="px-3 py-1 bg-slate-100 rounded text-xs font-bold text-slate-500 hover:bg-slate-200 cursor-pointer">
                    #Shipping
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="w-8 h-8 rounded-full bg-sky-100 text-sky-500 flex items-center justify-center hover:bg-sky-500 hover:text-white transition-colors">
          ...
          <div className="lg:col-span-4 space-y-8">
            ...
            <div className="bg-white rounded-2xl shadow-card p-6 border border-slate-100 sticky top-24">
              ...
              <div className="space-y-6">
                {NEWS_POSTS.filter((p) => p.id !== post.id)
                  .slice(0, 4)
                  .map((rel) => (
                    <Link
                      to={`/tin-tuc/${rel.slug}`}
